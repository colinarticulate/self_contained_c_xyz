...
class PronGO {
  ...
  late final _MockPronPtr = _lookup<
      ffi.NativeFunction<
          GoString Function(GoString, GoString, GoString, GoString, GoString,
              GoString, GoString, GoString)>>('MockPron');
  late final _MockPron = _MockPronPtr.asFunction<
      GoString Function(GoString, GoString, GoString, GoString, GoString,
          GoString, GoString, GoString)>();

  ffi.Pointer<ffi.Char> Pron(
    GoString audiofile,
    GoString word,
    GoString outputfolder,
    GoString dictfile,
  ...
  late final _PronPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(GoString, GoString, GoString, GoString,
              GoString, GoString, GoString, GoString)>>('Pron');
  late final _Pron = _PronPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(GoString, GoString, GoString, GoString,
          GoString, GoString, GoString, GoString)>();
}
