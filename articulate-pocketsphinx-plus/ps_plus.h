...
class XYZ_PocketSphinx {
    ...
    public:
        ...
        int
        ps_reinit_buffered(void) //(ps_decoder_t *ps, cmd_ln_t *config, void *buffer, size_t size) // buffer for jsgf grammar
        {
            const char *path;
