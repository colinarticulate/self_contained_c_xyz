...
//void load_data(char *p1[], char *p2[], char *p3[], char *p4[], char *p5[], struct Data data[5]) {
    ...
    data[1].params.size=p2_size; //number_parameters((char**)p2);
...
//         DATA(int num_items) {
//             capacity = num_items;
//             data = (struct PS_Data*)malloc(capacity*sizeof(struct PS_Data));
//             if(data==NULL){
...
//             if( items < capacity) {
//                 int i = std::max(items-1,0);
                
//                 int nparams = number_parameters((char**)p);
//                 data[i].params.p = (char**)malloc(sizeof(char*)*nparams);
//                 data[i].params.size=nparams;
//                 for(int j=0; j<nparams; j++){
//                     data[i].params.p[j]=(char*)malloc(strlen(p[j])+1);
//                     strcpy(data[i].params.p[j],p[j]);
//                 }
...
//             } else {
//                 printf("Capacity reach! Can't add more data.\n");
//             }
...
//                 int nparams = data[i].params.size;
//                 for(int j=0; j<nparams;j++){
//                     free(data[i].params.p[j]);
//                 }
//                 free(data[i].params.p);
//                 free(data[i].jsgf.buffer);
//                 free(data[i].wav.buffer);
//             }
//             free(data);
//         }
// };