...
SWIGINTERN PyObject *_wrap_Decoder_unset_search(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  int errcode;
  arg3 = &errcode;
  if (!SWIG_Python_UnpackTuple(args, "Decoder_unset_search", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Decoder, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Segment_ascore_set", _wrap_Segment_ascore_set, METH_VARARGS, "Segment_ascore_set(Segment self, int ascore)"},
	 { "Segment_ascore_get", _wrap_Segment_ascore_get, METH_O, "Segment_ascore_get(Segment self) -> int"},
	 { "Segment_lscore_set", _wrap_Segment_lscore_set, METH_VARARGS, "Segment_lscore_set(Segment self, int lscore)"},
	 { "Segment_lscore_get", _wrap_Segment_lscore_get, METH_O, "Segment_lscore_get(Segment self) -> int"},
	 { "Segment_lback_set", _wrap_Segment_lback_set, METH_VARARGS, "Segment_lback_set(Segment self, int lback)"},
	 { "Segment_lback_get", _wrap_Segment_lback_get, METH_O, "Segment_lback_get(Segment self) -> int"},
	 { "Segment_prob_set", _wrap_Segment_prob_set, METH_VARARGS, "Segment_prob_set(Segment self, int prob)"},
	 { "Segment_prob_get", _wrap_Segment_prob_get, METH_O, "Segment_prob_get(Segment self) -> int"},
	 ...
	 { "Segment_fromIter", _wrap_Segment_fromIter, METH_O, "Segment_fromIter(void * itor) -> Segment"},
	 ...
	 { "NBest_score_set", _wrap_NBest_score_set, METH_VARARGS, "NBest_score_set(NBest self, int score)"},
	 { "NBest_score_get", _wrap_NBest_score_get, METH_O, "NBest_score_get(NBest self) -> int"},
	 { "NBest_fromIter", _wrap_NBest_fromIter, METH_O, "NBest_fromIter(void * itor) -> NBest"},
	 ...
	 { "new_SegmentIterator", _wrap_new_SegmentIterator, METH_O, "new_SegmentIterator(void * ptr) -> SegmentIterator"},
	 ...
	 { "new_NBestIterator", _wrap_new_NBestIterator, METH_O, "new_NBestIterator(void * ptr) -> NBestIterator"},
	 ...
	 { "Decoder_unset_search", _wrap_Decoder_unset_search, METH_VARARGS, "Decoder_unset_search(Decoder self, char const * search_name)"},
