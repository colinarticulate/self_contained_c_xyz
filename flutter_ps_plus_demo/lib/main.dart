...
class FFIBridge {
  static bool initialize() {
    ...
    final _some_parameters =
        nativeApiLib.lookup<NativeFunction<Pointer<ArrayOfStrings> Function()>>(
            'get_some_parameters');
    c_get_some_parameters =
        _some_parameters.asFunction<Pointer<ArrayOfStrings> Function()>();
  ...
  static Pointer<Array> get_some_parameters() {
    Pointer<Array> result = c_get_some_parameters();
    print(result);
    return result;
  }
}
      ...
      body: Center(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('From C = ${FFIBridge.helloworld()}',
              style: TextStyle(fontSize: 40)),
          // Text('params = ${FFIBridge.get_some_parameters()}',
